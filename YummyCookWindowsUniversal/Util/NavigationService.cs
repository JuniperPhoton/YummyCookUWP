...
using YummyCookWindowsUniversal.Util;

namespace GalaSoft.MvvmLight.Views
{
    /// <summary>
    /// Windows 8 and Windows Phone Application 8.1 implementation of <see cref="INavigationServiceEx"/>.
    /// </summary>
    ...
    /// <summary>
    /// If the Window.Current.Content is a page, we should to implement the 
    /// interface to get the actual frame.
    /// </summary>
